...
1. For every 🚨 Critical and 🤔 Important gap, apply the **best practice resolution**
   directly. Use your expertise as senior strategist — don't invent new requirements,
...
> filling reasonable defaults for ambiguous items. If the resolution is genuinely
> unknown or requires product decision, note it and let the review gate
> catch it.
